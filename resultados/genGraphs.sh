...
f1="sir-a:0.0001-b:0.125-dt:0.1-I:1-S:999-R:0-M:1-C:1.txt"
apt="4-Cuarentena"
gnuplot -e "filename='$f1';apartado='$apt'" getGraphs.plt
    #b) Mejoramos las vacunas/medicinas:
f1="sir-a:0.001-b:0.25-dt:0.1-I:1-S:999-R:0-M:1-C:1.txt"
apt="4-Vacunas"
gnuplot -e "filename='$f1';apartado='$apt'" getGraphs.plt
    #c) La imunidad ahora dura más tiempo:
f1="sir-a:0.001-b:0.125-dt:0.1-I:1-S:999-R:0-M:1-C:1.txt"
apt="4-Imunidad"
gnuplot -e "filename='$f1';apartado='$apt'" getGraphs.plt

# Apartado 5
    # a) Número de infectados inciales mayor
f1="sir-a:0.001-b:0.125-dt:0.1-I:10-S:999-R:0-M:1-C:1.txt"
apt="5-MasInfectados"
gnuplot -e "filename='$f1';apartado='$apt'" getGraphs.plt
